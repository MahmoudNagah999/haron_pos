...
SELECT item,Price,Quantity,Discount,Total,SupplierID,BuyPrice,date,type,sales_type,subqty,size,color,user_id from " . $prefix . "_sales_temporary")) {
                                    ...
                                    ?>
                                    <a href="sales.php?q=d"><img src="images/c.png" style="width:30px; height:30px; float:left; border:0px;"  title="<?php echo"$Cancel_lang"; ?>"/></a>
        ...
        <?php } ?>
							...
							'.$suspended_bill_lang.'
                                 ...
                                 $DiscountValuet = ($quantityt * $Pricet) * ($Discountt / 100);
									...
									//	echo ($inv_Totalt);
                                       ...
                                       echo $total_inv_after_alldiscount_and_tax_ship=$total_inv_after_alldiscount_and_tax+$_POST['shipping'];
                                       echo"<br />";
                                       echo $paid; 
							...
							'.$must_choose_customer.'
                                            ...
                                            if ($paid < 0 or $paid == null or $paid == "") {
                                                ...
                                                $sqlpayments_suppliers = "INSERT INTO " . $prefix . "_sales_inv (supplier, Total, date, PaymentMethod, DueDate, notes, type, discount, staff, doc, tax, user_id)
VALUES ('" . $_POST['SupplierID'] . "','" . ($paid * -1) . "','" . $DueDate . "','" . $pay . "','','" . $notes . "','3','" . $_POST['alldiscount'] . "','" . $_POST['staff'] . "','" . $_POST['doc'] . "','" . (($db_tax/(100+$db_tax))*(($inv_Totalt - $alldiscount))) . "','" . $user_id . "')";
                                                if (!mysqli_query($con, $sqlpayments_suppliers)) {
                                                    ...
                                                    if ($alldiscount <= 0) {
                                                        ...
                                                        $sqlpayments = "INSERT INTO " . $prefix . "_sales_inv (supplier, Total, date, PaymentMethod, DueDate, notes, type, discount, staff, doc, tax, user_id)
VALUES ('" . $_POST['SupplierID'] . "','" . (($alldiscount) * -1) . "','" . $DueDate . "','" . $pay . "','','".$Cash_discount_lang."','3','" . $_POST['alldiscount'] . "','" . $_POST['staff'] . "','" . $_POST['doc'] . "','" . (($db_tax/(100+$db_tax))*(($inv_Totalt - $alldiscount))) . "','" . $user_id . "')";
...
######################
                                            if ($pp == 1) {
                                                $sqlt = "INSERT INTO " . $prefix . "_treasury (type, Amount, date, notes, inv_id, inv_type, client_supp_name)
VALUES ('4','" . $paid . "','" . $DueDate . "','تحصيلات نقدية','" . $get_LastInvoiceNo . "','1','" . $_POST['SupplierID'] . "')";
...
if($db_tax>0){$add_tax_inv=($inv_Total-$_POST['alldiscount'])*$db_tax/100;}else{$add_tax_inv=0;}
                                            if (mysqli_query($con, "INSERT INTO " . $prefix . "_sales_inv(inv_id, date, Total, supplier, PaymentMethod, DueDate, CheckNumber, notes, type, paid, discount, staff, doc, tax, shipping, user_id)
VALUES ('" . $get_LastInvoiceNo . "','" . $DueDate . "','" . $inv_Total . "','" . $_POST['SupplierID'] . "','" . $pay . "','','" . $CheckNumber . "','" . $notes . "','1','" . $paid . "','" . $_POST['alldiscount'] . "','" . $_POST['staff'] . "','" . $_POST['doc'] . "','" .$add_tax_inv. "','" . $_POST['shipping'] . "','" . $user_id . "')")) {
                                                $Report_Create_Invoice = 1;
##############
                                                if (mysqli_query($con, "INSERT INTO " . $prefix . "_sales(Quantity, Discount, Total, SupplierID, BuyPrice, date, type, sales_type, subqty, inv_id, item, Price, size, color, user_id, staff)
SELECT (CASE when sales_type=2 then  Quantity/subqty else Quantity END) ,Discount,Total,SupplierID,BuyPrice,date,type,sales_type,subqty,inv_id,item,Price,size,color,user_id,staff from " . $prefix . "_sales_temporary where user_id='$user_id'")) {
    ...
    ?>
                                ...
                                <table width="100%" dir="rtl">
                                    <tr>
                                        ...
                                        <td style="font-size:16px;"><input type="text" name="paid" value="<?php  if($db_tax>0){echo ((($sumTotal-$print_total_disc)*$db_tax/100)+($sumTotal-$print_total_disc)+$_POST['shipping']);}else{echo ($sumTotal - $print_total_disc+$_POST['shipping']);} ?>"  style="text-align:center; background-color:#CCC; width:50px; height:20px;"/></td>
                                        ...
                                        <td><input type="text" name="date" id="date" value="<?php if ($_POST['date'] == "") {
                                         ...
                                         <td style="font-size:16px;"><input   style="text-align:center; background-color:#CCC; width:80px; height:20px;" type="text" name="shipping" value="<?php echo"" . $_POST['shipping'] . ""; ?>" /></td>
                                    </tr>
                                    <tr>
                                        <td class="text-left" style="font-size:16px;"><?php echo"$Discount_lang"; ?></td>
                                        <td><input type="text" name="alldiscount" value="<?php echo"" . $_POST['alldiscount'] . ""; ?>"  style="text-align:center; background-color:#CCC; width:50px; height:20px;"/></td>
...
?>
                                                                  ...
                                                                  <td style="font-size:16px;"  class="text-left"><?php echo"DOC#"; ?></td>
                                        <td><input type="text" name="doc" value="<?php echo"" . $_POST['doc'] . ""; ?>"  style="text-align:center; background-color:#CCC; width:50px; height:20px;"/></td>
                                    </tr>
                                    <tr>
