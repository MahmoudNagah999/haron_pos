            ...
            $('select[name="region_id"]').change(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $('select[name="centers_id"]').html(data).trigger('change');
                    }
                });
            });
        });
                    ...
                    <div style="width:60%;border:1px solid #CCC; border-radius:5px; float:right; ">
                        <div>
                            ...
                            <div style="width:100%; padding-top:10px; text-align:center; margin:0 auto;border:0px solid #CCC; border-radius:5px;"">
                                ...
                                <a class=" addProd" par="q" attr="d"><img src="images/c.png"
                                    style="width:30px; height:30px; float:left; border:0px;"
                                    title="<?php /*echo"$Cancel_lang"; */ ?>" /></a>
                                ...
                                if ($_GET['print_inv'] !== null) {
                                    ...
                                    <?php if ($GsupplierID == null) {
                                        ...
                                        <a href="#" onclick="javascript:void window.open('statement_of_account_client.php?id=<?php echo "" . $GsupplierID . ""; ?>&from=<?php echo "" . date("Y-m-01") . ""; ?>&to=<?php echo "" . date("Y-m-d") . ""; ?>', '1390937502641', 'width=1024,height=600,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=0,left=0,top=0,menubar=0');
                                                    return false;"><img src="images/arrears_list.gif"
                                                style="float:left; border:0px; margin-top:10px;"
                                                title="<?php echo "$client_statement_lang"; ?>" /></a>
                                    <?php } ?>
                                <?php } ?>
							...
							' . $suspended_bill_lang . '
                                ...
                                if (($_POST['submit']) == $Save_lang and $_POST['submit'] != null) {
                                    ...
                                    while ($row_upt = mysqli_fetch_array($result_upt)) {
                                        //echo $row_up['id'];
                                        $quantityt = (float) $_POST['quantity' . $row_upt['id']];
                                        $Pricet = (float) $_POST['price' . $row_upt['id']];
                                        $stafft = $_POST['staff' . $row_upt['id']];
                                        $Discountt = (float) $_POST['discount' . $row_upt['id']];
                                    ...
                                    if ($Discount_type == 2) {
                                        $alldiscount = (float) trim($inv_Totalt * ($_POST['alldiscount'] ?? 0) / 100);
                                    } else {
                                        $alldiscount = (float) trim($_POST['alldiscount'] ?? 0);
                                    }
...
//                                        }else{
                                    $total_inv_after_alldiscount_and_tax = ((float) $inv_Totalt - (float) $alldiscount);
                                    //                                        }
                                    $total_inv_after_alldiscount_and_tax_ship = $total_inv_after_alldiscount_and_tax + (float) ($_POST['shipping'] ?? 0);
                                    // echo"<br />";
                                    //  echo $paid;
...
//                                        die();
							...
							' . $must_type_address . '
                                        ...
                                        while ($row_up = mysqli_fetch_array($result_up)) {
                                            ...
                                            $quantity = (float) $_POST['quantity' . $row_up['id']];
                                            $Price = (float) $_POST['price' . $row_up['id']];
                                            $staff = $_POST['staff' . $row_up['id']];
                                            $Discount = (float) $_POST['discount' . $row_up['id']];
...
###########################################
                                        ...
                                        ######################
                                        if ($db_tax > 0) {
                                            $add_tax_inv = ($inv_Total - $_POST['alldiscount']) * $db_tax / 100;
                                        } else {
                                            $add_tax_inv = 0;
                                        }
                                        ...
                                        if (
                                            ...
                                            if (
                                                mysqli_query($con, "INSERT INTO " . $prefix . "_order_supply(item_status,Quantity, Discount, Total, SupplierID, BuyPrice, date, type, order_supply_type, subqty, inv_id, item, Price, size, color, user_id, staff)
                                ...
                                <form method="post" id="inv_form">
                                    ...
                                    <div class="row" dir="rtl">
                                        <div class="col-12">
                                            ...
                                            <input type="text" placeholder=" <?php echo "$The_client_lang"; ?>"
                                                name="client" value="<?php echo "" . $_POST['client'] . ""; ?>" />
                                            <br />
                                            <br />
                                            <br />
                                        </div>
                                    ...
                                    <div class="row" dir="rtl" style="margin-bottom: 10px;">
                                        <div class="col-md-4">
                                            <select name="centers_id" size="1"
                                                class="js-example-placeholder-single3 js-states form-control">
                                    ...
                                    <div class="row" dir="rtl" style="margin-bottom: 10px;">
                                        <div class="col-md-12">
                                            <input type="text" placeholder=" <?php echo "$Address1_lang"; ?>" name="address"
                                                class="form-control" value="<?php echo "" . $_POST['address'] . ""; ?>"
                                                style="width: 100%;" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" dir="rtl" style="margin-bottom: 10px;">
                                        <div class="col-md-4">
                                            <input type="text" pattern="[0-9]{11}" title="<?php echo $mobile_error; ?>"
                                                name="mobile1" placeholder="<?php echo "$Mobile1_lang"; ?>"
                                                class="form-control" value="<?php echo "" . $_POST['mobile1'] . ""; ?>" />
                                        </div>

                                        <div class="col-md-4">
                                            <input type="text" pattern="[0-9]{11}" title="<?php echo $mobile_error; ?>"
                                                name="mobile2" placeholder="<?php echo "$Mobile2_lang"; ?>"
                                                class="form-control" value="<?php echo "" . $_POST['mobile2'] . ""; ?>" />
                                        </div>

                                        <div class="col-md-4">
                                            <select name="alpha" size="1"
                                                class="js-example-placeholder-single4 js-states form-control">
                                                <option value="" <?php if ($_POST['alpha'] == "") {
...
//                                        }
                                            ...
                                            if ($sumTotal == null) {
                                                ...
                                                if ($use_sizes == 1) {
                                                    ...
                                                    if ($use_colors == 1) {
                                                        ...
                                                        echo '<td colspan="4">' . $the_total_lang . '</td>';
                                                    }
                                                }
                            ...
                            <td></td>
                                                ...
                                                if ($use_sizes == 1) {
                                                    if ($use_colors == 1) {
                                                        echo '<td colspan="6">' . $the_total_after_lang . '</td>';
                                                    } else {
                                                        echo '<td colspan="5">' . $the_total_after_lang . '</td>';
                                                    }
                                                    ...
                                                    if ($use_colors == 1) {
                                                        ...
                                                        echo '<td colspan="4">' . $the_total_after_lang . '</td>';
                                                    }
                                                }
                                                $print_total_disc = 0;
                                                if ($Discount_type == 2) {
                                                    $print_total_disc = (float) $sumTotal * (float) ($_POST['alldiscount'] ?? 0) / 100;
                                                } else if ($Discount_type == 1) {
                                                    $print_total_disc = (float) ($_POST['alldiscount'] ?? 0);
                                                } else {
                                                }
                                                echo '<td><font style="color:#060; font-weight:bold;">' . ((float) $sumTotal - (float) $print_total_disc) . '</font></td>
                            <td></td>
                            </tr>';
                                            }
                                            if ($_POST['shipping'] > 0) {
                            ...
                            <table width="100%" dir="rtl">
                                <tr>
                                    ...
                                    <td style="font-size:16px;"><input class="gr"
                                            style="text-align:center; background-color:#CCC; width:80px; height:20px;"
                                            type="text" name="shipping"
                                            value="<?php echo "" . $_POST['shipping'] . ""; ?>" /></td>

                                    <td class="text-left" style="font-size:16px;"><?php echo "$Discount_lang"; ?></td>
                                    <td><input class="gr" type="text" name="alldiscount"
                                            value="<?php echo "" . $_POST['alldiscount'] . ""; ?>"
                                            style="text-align:center; background-color:#CCC; width:50px; height:20px;" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:16px;">
                                        <textarea class="form-control" style="text-align: center"
                                            name="notes"><?php echo $_POST['notes']; ?></textarea>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><input style="display:none;" type="checkbox" name="inv_tax" id="inv_tax" value="1"
                                            <?php if ($_POST['inv_tax'] == null or $_POST['inv_tax'] == "0") {
                                            } else {
                                                echo ' checked="checked"';
                                            } ?> /></td>

                                    <!--                                        <td style="font-size:16px;"  class="text-left">--><?php //echo"$the_Employee"; ?><!--</td>-->
                                    <td><select name="staff" style="display:none;"
                                            style="text-align:center;background-color:#CCC; float:right;">
                                            <option value="" <?php if ($_POST['staff'] == "" or $_POST['staff'] == null) {
                                                echo "selected='selected'";
                                            } else {
                                            } ?>></option>
                                            <?php
                                ...
                                <tr>
                                    <td colspan="6" align="center"><span style=" text-align:center; margin-right:50px;">
                                            ...
                                            <input type="submit" name="submit" value="<?php echo $Save_lang ?>"
                                ...
                                <div class="text-center">
                                    <?php if ($run_barcode == 0) {
                                        ...
                                        ?>" <?php if ($run_barcode == 0) {
                                            ...
                                            echo 'autofocus onfocus="this.select()"';
                                    ...
                                    <input type="text" <?php if ($run_barcode == 0) {
                                        echo "autofocus";
                                    } ?> name="search_box"
                                        id="search_box" value="<?php echo "$item_Name_lang"; ?>"
                                        style="background-color:#CCC; z-index:100000000000;"
                                        onkeyup="showResultsOfItems(this.value)" autocomplete="off"
                                        onclick="this.value = '';" onfocus="this.select()"
                                        onblur="this.value = !this.value ? '<?php echo "$item_Name_lang"; ?>' : this.value;" />
                                    <div id="livesearch"
                                        style="z-index:1000000000; width:45%;  text-align:right; margin-top:0px;  float:right; position:fixed; border:0px; ">
                                    </div>
        ...
        <div class="modal-dialog" style="width:100%">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button onClick="window.location.href=window.location.href" type="button" class="btn btn-default"
                        data-dismiss="modal"><?php echo "$Close_lang"; ?></button>
                </div>
            </div>
