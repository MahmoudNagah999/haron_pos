...
<body class="cmenu1 example-target">
    ...
    <div id='main'>
        <article style="margin-bottom:70px;">
            ...
            <fieldset>
                <legend align="right"><?php echo "$the_items_lang"; ?>: <li style="cursor:pointer;"
                        class="glyphicon glyphicon-minus" onclick="toggle_visibility('myForm');"></li>
                </legend>
                <?php
...
VALUES ('" . $groups . "','" . $items . "','" . $date . "','" . $Quantity . "','" . $Sale_price . "','" . $price . "','" . $Barcode . "','" . $Supplier . "','" . $Discount . "','" . $OrderNo . "','" . $useimage . "','" . str_replace("uploads/", "", "" . $result[1] . "") . "','" . $Background . "','" . $subprice . "','" . $subqty . "','" . $alert_shortcomings . "','" . $companies . "','" . $add_size . "','" . $add_color . "')";
     ...
     ' . $not_saved_try_lang . '
         ...
         ' . $Data_is_saved_lang . '
                    ...
                    ?>
                    <?php
                    if ($user_edit_item !== "1" and $user_IsAdmin != "1") {
                    } else {
                        if ($_GET['Edit'] !== null) {
                            $isedit = 1;
                            ...
                            if (mysqli_num_rows($result_items) > 0) {
                                while ($row_items = mysqli_fetch_array($result_items)) {
                                    ...
                                    $all_qty002 = round((abs($NumberBreakdown2[1]) * (float)$row_items['subqty']));
                    ...
                    if ($row_items_Background == "" or $row_items_Background == null) {
                        $row_items_Background = "#ffffff";
                    }
                    ?>
                    ...
                    //  die('');
                        ...
                        <form id="myForm" style="disply:block;" method="post" name="myForm" enctype="multipart/form-data"
                            autocomplete="off">
                            <table border="0" dir="rtl" cellpadding="0"
                                style="padding-top:30px; text-align:right; color:#009; width:100%;">

                                <tr>
                                    <td class="text-right">
                                        <lable><?php echo "$the_Item_lang"; ?></lable>
                                    </td>
                                    ...
                                    <td hidden class="text-right">
                                        <lable><?php echo "$the_date_lang"; ?></lable>
                                    </td>
                                    <td class="text-right">
                                        <input type="hidden" name="date" value="<?php if ($date == "") {
                                            echo date("d/m/Y");
                                        } else {
                                            if ($row_items_date == "01/01/1970") {
                                            } else {
                                                echo "" . $row_items_date . "";
                                            }
                                ...
                                <tr>
                                    <td class="text-right">
                                        <lable><?php echo "$the_Group"; ?></lable>
                                    </td>
                                    <td class="text-right">


                                        <select name="groups" class="form-control"
                                            style="width:80%; float: right; <?php echo "$error_groups"; ?>">
                                            <option value=""></option>
                                            <?php
                                        ...
                                        <a href="groups.php" target="$_BLANK">
                                            <li class="fa fa-plus-circle fa-2x float-right"></li>
                                        </a>
                                ...
                                <tr>
                                    <td hidden class="text-right">
                                        <lable><?php echo "$opening_balance_lang"; ?></lable>
                                    </td>
                                    <td hidden class="text-right"><input name="Quantity" value="<?php if (isset($_POST['Quantity']) && $_POST['Quantity'] == "") {
                                        echo "" . $row_items_Quantity . "";
                                    } else {
                                        echo (isset($_POST['Quantity']) ? $_POST['Quantity'] : "");
                                        // echo"" . $Quantity . "";
                                    } ?>" class="form-control" />

                                    </td>
                                    <td class="text-right">
                                        <lable><?php echo "$Purchasing_price_lang"; ?></lable>
                                    </td>
                                    <td class="text-right">
                                    ...
                                    <td class="text-right">
                                        <lable><?php echo "$Selling_price_lang"; ?></lable>
                                    </td>
                                ...
                                <tr>
                                    <?php if ($BARCODE_type == 1) { ?>
                                        <td class="text-right">
                                            <lable><?php echo "$barcode_lang"; ?></lable>
                                        </td>
                                        <td class="text-right">
                                    ...
                                    <td class="text-right">
                                        <lable><?php echo "$Ranking_lang"; ?></lable>
                                    </td>
                                ...
                                <tr>
                                    <td class="text-right">
                                        <lable><?php echo "$Image_lang"; ?></lable>
                                    </td>
                                    <td class="text-right"><input type="checkbox" name="useimage" value="1" class="form-control"
         <?php if ($useimage == "1") {
             echo "checked";
             ...
             echo "checked";
                                    ...
                                    <td class="text-right"><span><input name="image" id="image" type="file"
                                                class="form-control" /></span></td>
                                    <td class="text-right">
                                        <lable><?php echo "$Background_lang"; ?></lable>
                                    </td>
                                    <td class="text-right"><input type="color" name="Background" id="color5" value="<?php if ($Background == "") {
                                        ...
                                        if (isset($_GET['Edit'])) {
                                            ...
                                            $sum_data = get_sum_product_store_data($id, $_GET['store_id'], $_GET['date_from'], $_GET['date_to']);
                                ...
                                <td class="text-right">
                                    <lable><?php echo "$Minimum_quantity_lang"; ?></lable>
                                </td>
                                ...
                                <?php if ($Retail_allow == "1") { ?>
                                    <tr>
                                        ...
                                        <td class="text-right"><input type="text" name="subqty"
                                                value="<?php echo $row_items_subqty; ?>" class="form-control" /></td>
                                        <td class="text-right">
                                            <lable><?php echo "$Sub_unit_price_lang"; ?></lable>
                                        </td>
                                                    ...
                                                    <select class="input-small.form-control" name="color[]" multiple="">
                                                        ...
                                                        if ($num_colors > 0) {
                                                            while ($row_colors = mysqli_fetch_array($result_colors)) {
                                                                if (in_array($row_colors['id'], $models_color_v_explode, true)) {
                                                    ...
                                                    <select class="input-small.form-control" name="size[]" multiple="">
                                                        ...
                                                        if ($num_sizes > 0) {
                                                            while ($row_sizes = mysqli_fetch_array($result_sizes)) {
                                                                if (in_array($row_sizes['id'], $modelssizevexplode, true)) {
                                                                    $sel = 'selected="selected"';
                                                                } else {
                                                                    $sel = "";
                                                                }
                                ...
                                <td class="text-right">
                                    ...
                                    ?>
                                    <input type="button" class="button" value="<?php echo "$Cancel_lang"; ?>"
                                        onclick="javascript:location.href = 'items_and_inventory.php'" />
                                </td>
                ...
                <form method="get">
                    ...
                    <select name="store_id" size="1" style="height:20px; width:20%;"
                    ...
                    <select name="Quanstatus" size="1" style="height:20px; width:20%;"
                        class="js-example-placeholder-single  js-states form-control">
                        <option <?php if ($_GET['Quanstatus'] == '1') {
                            echo 'selected="selected"';
                        } ?> value="1">الكميات فقط
                        </option>
                        <option <?php if ($_GET['Quanstatus'] == '2' or !isset($_GET['Quanstatus'])) {
                            echo 'selected="selected"';
                        } ?> value="2">بدون كميات </option>
                        <option <?php if ($_GET['Quanstatus'] == '0' or !isset($_GET['Quanstatus'])) {
                            echo 'selected="selected"';
                        } ?> value="0">الكل </option>

                    </select>
                    <select name="search" size="1" style="height:20px; width:20%;"
                        class="js-example-placeholder-single  js-states form-control">
                    ...
                    <select name="groups" size="1" style="height:20px; width:20%;"
                        class="js-example-placeholder-single  js-states form-control">
                ...
                <form id="mainform" action="" method="post">
                    <table border="1"
                        style="font-size: 16px; width: 100%; direction: rtl; border: 1px; border-collapse: collapse; margin-top: 10px;text-align:center; table-layout: fixed;"
                        class="container" id="container">
                        <thead style="background-color:#CCC;">
                            <th style="width:5%;" class="text-center"><input type="checkbox" name="all" value="1"
                                    id="all" /></th>
                            ...
                            <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "id") {
                                ...
                                echo "sort0";
                                    ...
                                    class="a_remove_underlines"><?php echo "$Code_lang"; ?></a></th>
                            <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "groupid") {
                                ...
                                echo "sort0";
                                    ...
                                    class="a_remove_underlines"><?php echo "$the_Group"; ?></a></th>
                            <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "OrderNo") {
                                ...
                                echo "sort0";
                                    ...
                                    class="a_remove_underlines"><?php echo "$Ranking_lang"; ?></a></th>
                            ...
                            <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "item") {
                                ...
                                echo "sort0";
                                    ...
                                    class="a_remove_underlines"><?php echo "$the_Item_lang"; ?></a></th>
                            ...
                            <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "Quantity") {
                                ...
                                echo "sort0";
                                    ...
                                    class="a_remove_underlines"><?php echo "$the_Quantity_lang"; ?></a></th>
                            ...
                            return false;"><img width="25" height="25" src="images/print_icon.gif"
                                        style="border:0px;"></a>
                            </th>
                        </thead>
                        <?php
                        ...
                        if ($orderby == "groupid") {
                            $sql = "SELECT i.*, g.GroupName as OB_FIELD FROM items i LEFT JOIN " . $prefix . "_groups g ON g.id=i.groupid WHERE $where_sql order by g.GroupName $type LIMIT $start, $limit";
                        } else {
                            $sort_col = $orderby;
                            if ($orderby != "item" && $orderby != "groupid") {
                                $sort_col = "$orderby+0";
                            }
                            $sql = "SELECT * FROM items WHERE $where_sql order by $sort_col $type LIMIT $start, $limit";
                        }
                        ...
                        while ($row = @mysqli_fetch_array($result)) {
                            ...
                            $sum_data_row = get_sum_product_store_data($row['id'], (isset($_GET['store_id']) ? $_GET['store_id'] : null), (isset($_GET['date_from']) ? $_GET['date_from'] : null), (isset($_GET['date_to']) ? $_GET['date_to'] : null));
                            ...
                            $all_qty = (abs($NumberBreakdown[1]) * (float)$row['subqty']);
                            ...
                            if (isset($_GET['Quanstatus']) and $whole == 0 and $_GET['Quanstatus'] == '1') {
                                ...
                                <tr class="text-center  <?php echo "" . $class . ""; ?>">
                                    <td class="text-center "><input type="checkbox" name="cb[]"
                                            value="<?php echo "" . $row['id'] . ""; ?>"></td>
                                    <td class="text-center "><?php echo "" . $row['id'] . ""; ?></td>
                                    <td class="text-center "><?php echo "" . $row_Groups . ""; ?></td>
                                    <td class="text-center "><?php echo "" . $row['OrderNo'] . ""; ?></td>
                                    <td class="text-center ">
                                        <?php echo "<a href='product_store.php?item=$item_id' >" . $row['item'] . "</a>"; ?></td>
                                    <td class="text-center ">
                                        <?php
                                        ...
                                        <?php } else { ?>
                                            <a
                                                href="item_analysis.php?id=<?php echo "" . $row['id'] . ""; ?>"><?php echo "" . $whole . "," . round($all_qty) . ""; ?></a>
                                        <?php } ?>
                                    </td>
                ...
                <td class="text-center ">
                    ...
                    <a onclick="return confirm('<?php echo "$sure_delete_lang"; ?>');"
                        href="?groups=<?php echo "" . $_GET['groups'] . ""; ?>&limit=<?php echo "" . $_GET['limit'] . ""; ?>&orderby=<?php echo "" . $_GET['orderby'] . ""; ?>&type=<?php echo "" . $_GET['type'] . ""; ?>&page=<?php echo "" . $_GET['page'] . ""; ?>&del=<?php echo "" . $row['id'] . ""; ?>"><img
                            src="images/erase.png" style="border:0px;" /></a>
                    <a
                        href="?groups=<?php echo "" . $_GET['groups'] . ""; ?>&limit=<?php echo "" . $_GET['limit'] . ""; ?>&orderby=<?php echo "" . $_GET['orderby'] . ""; ?>&type=<?php echo "" . $_GET['type'] . ""; ?>&page=<?php echo "" . $_GET['page'] . ""; ?>&Edit=<?php echo "" . $row['id'] . ""; ?>"><img
            ...
            return false;"><img src="images/arrears_list.gif" style="border:0px;"
                            title="<?php echo "$Statement_Item_lang"; ?>" /></a>
            ...
            return false;"><img src="images/barcode.png" style="border:0px;" /></a>
                    <?php // } ?>
                    <a onclick="return confirm('<?php echo "$sure_hide_item_lang"; ?>');"
                        href="?hide=<?php echo "" . $row['id'] . ""; ?>"><img src="images/eye-dark.png" width="16" height="16" /></a>
                </td>
                </tr>
