...
<div class="container-fluid">
 ...
 <div class="form-group mb-2">
    <input type="text" name="date_to" value="<?php echo $_GET['date_to']; ?>" class="form-control date" placeholder="التاريخ الى" aria-label="التاريخ الى">
  </div>
 <div class="form-group mb-2">
    <input type="text" name="date_from" value="<?php echo $_GET['date_from']; ?>"  class="form-control date" placeholder="التاريخ من" aria-label="التاريخ من">
  </div>
 <div class="form-group mb-2">
