                                                <?php
			if($user_order_supplyReports!=="1" and $user_IsAdmin!=1){
...
<thead>
<td colspan="7" style="background-color:#09F;"><strong style="color:#FFF; font-size:22px;">  <?php echo"$order_supply_items_lang"; ?></strong></td>
</thead>
...
$sql = "SELECT * FROM ".$prefix."_order_supply where item=".$_GET['q']." and type='1' and left(date,10) BETWEEN '$from' AND '$to' order by date DESC LIMIT $start, $limit";	
...
$result_get = mysqli_query($con,"SELECT Total FROM ".$prefix."_order_supply where item=".$_GET['q']." and type='1' and left(date,10) BETWEEN '".$from."' AND '".$to."'");
