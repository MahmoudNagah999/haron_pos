...
<thead>
<td colspan="7" style="background-color:#09F;"><strong style="color:#FFF; font-size:22px;"> <?php echo"$Returns_Purchases_lang"; ?></strong></td>
</thead>
...
?>
 ...
 <a href="receivings_returns_edit.php?id=<?php echo"".$row['inv_id'].""; ?>"><img src="images/edit.png"/></a>
<a href="#" onclick="javascript:void window.open('invoice.php?id=<?php echo"".$row['inv_id'].""; ?>&type=receivings_returns','1390937502641','width=700,height=600,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=0,left=0,top=0,menubar=0');return false;"><img src="images/view.png"/></a>
