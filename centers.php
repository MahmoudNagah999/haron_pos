                ...
                <fieldset class="clearfix">
                    ...
                    if ($_GET['del'] !== null) {
                        if ($demo == 1) {
                            ...
                            mysqli_query($con, "DELETE FROM " . $prefix . "_centers WHERE  id='" . $_GET['del'] . "'");
                    ...
                    $checkbox = isset($_POST['cb']) ? $_POST['cb'] : []; //from name="checkbox[]"
                  ...
                  ' . $demo_alert . '
                            ...
                            for ($i = 0; $i <= $countCheck; $i++) {
                                $del_id = $checkbox[$i];
                                mysqli_query($con, "DELETE FROM " . $prefix . "_centers WHERE id ='" . $del_id . "'");
                                if (mysqli_affected_rows($con) > 0) {
                                    if ($i == $countCheck - 1) {
                                        if (mysqli_affected_rows($con) > 0) {
                                            echo '<div class="alert alert-success text-right">
                            ...
                            header("refresh:1;url=centers.php");
                        }
                    }
                        ...
                        if ($demo == 1) {
                            ...
                            if ($name == "" or $name == null) {
                                ...
                                if (isset($_POST['modification'])) {
                                    ...
                                    $sql = "UPDATE " . $prefix . "_centers SET name='" . $name . "',parent_id='" . $parent_id . "' where id=" . $_POST['id'] . "";
                                } else {
                                    $sql = "INSERT INTO " . $prefix . "_centers (name, parent_id) VALUES ('" . $name . "','" . $parent_id . "')";
                                }
                                ...
                                ' . $Data_is_saved_lang . '
                                    ...
                                    header("refresh:1;url=centers.php?limit=" . $_GET['limit'] . "&orderby=" . $_GET['orderby'] . "&type=" . $_GET['type'] . "&page=" . $_GET['page'] . "");
                                }
                            }
                        }
                    }
                    ...
                    if ($_GET['Edit'] !== null) {
                        $isedit = 1;
                        $result_region = mysqli_query($con, "SELECT * FROM " . $prefix . "_centers where id='" . $_GET['Edit'] . "'");
                        ...
                        <table border="0" dir="rtl" cellpadding="0" style="padding-top:30px; text-align:right; color:#009; width:100%;">
                            <tr>
                                <td class="text-center">
                                    <lable><?php echo "$region_name"; ?></lable>
                                </td>
                                <td class="text-right">
                            ...
                            <tr>
                                <td class="text-center">
                                    <lable><?php echo "$parent_id_lang"; ?></lable>
                                </td>
                                <td class="text-right">
                            ...
                            <!--      <tr>-->
                            <!--        <td class="text-center"><lable>--><?php //echo"$parent_id_lang";
                                                                            ?><!--</lable></td>-->
                            <!--          <div>-->
                            ...
                            <tr>
                                <th colspan="6" class="text-center">
                                    <div>
                                        ...
                                        ?>
                                        <input type="button" class="button" value="<?php echo "$Cancel_lang"; ?>" onclick="javascript:location.href='centers.php'" />
                                    </div>
                                </th>
                            </tr>
                            <tr class="text-right">
                ...
                <form id="mainform" action="" method="post">
                    <table border="1" style="font-size:16px; width:100%; direction:rtl; border:1px; border-collapse:collapse; margin-top:10px; margin-bottom:40px; text-align:center;" class="container" id="container">
                        <thead style="background-color:#CCC;">
                            ...
                            <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "parent_id") {
                                                        echo "sort_t";
                                                    } else if ($_GET['type'] == "DESC" and $_GET['orderby'] == "parent_id") {
                                                        echo "sort_d";
                                                    } else {
                                                        echo "sort0";
                                                    } ?>"><a href="?orderby=parent_id&type=<?php if ($_GET['type'] == "ASC") {
                                                                echo "DESC";
                                                            } else if ($_GET['type'] == "DESC") {
                                                                echo "ASC";
                                                            } else {
                                                                echo "DESC";
                                                            } ?>&page=<?php echo "" . $_GET['page'] . ""; ?>" class="a_remove_underlines"><?php echo "$parent_id_lang"; ?></a></th>
                    ...
                    */
                        $query = "SELECT COUNT(*) as num  FROM  " . $prefix . "_centers order by $orderby $type";
                        ...
                        /* Get data. */
                        if ($orderby == "id") {
                            $sql = "SELECT * FROM " . $prefix . "_centers  order by $orderby+0 $type LIMIT $start, $limit";
                        } else {
                            $sql = "SELECT * FROM " . $prefix . "_centers  order by `$orderby` $type LIMIT $start, $limit";
                        }
