                        ...
                        <div>
                            ...
                            <div
                                ...
                                if (($_POST['submit']) == $Save_lang and $_POST['submit'] != null) {
                                    ...
                                    //	echo ($inv_Totalt);
                                    if ($db_tax > 0) {
                                        $total_inv_after_alldiscount_and_tax = ((float) $inv_Totalt - (float) $alldiscount) + (((float) $inv_Totalt - (float) $alldiscount) * (float) $db_tax / 100);
                                    } else {
                                    ...
                                    <div class="row" dir="rtl">
                                        <div class="col-12">
                                            ...
                                            <input type="text" placeholder=" <?php echo "$The_client_lang"; ?>"
                                                name="client" value="<?php echo "" . $data['client'] . ""; ?>" />
                                            <br />
                                            <br />
                                            <br />
                                        </div>
                                    ...
                                    <div class="row" dir="rtl" style="margin-bottom: 10px;">
                                        <div class="col-md-4">
                                            <select name="centers_id" size="1"
                                                ...
                                                } else if (isset($data['region_id']) && $data['region_id'] != "") {
                                                    $region_id = $data['region_id'];
                                                }

                                                if ($region_id != "") {
                                                    $ProductsName = mysqli_query($con, "SELECT * FROM " . $prefix . "_centers WHERE parent_id='$region_id' order by parent_id ASC");
                                                } else {
                                                ...
                                                if ($num_item > 0) {
                                                    while ($row_item = mysqli_fetch_array($ProductsName)) {
                                                        if ($row_item['id'] == $data['centers_id']) {
                                    ...
                                    <div class="row" dir="rtl" style="margin-bottom: 10px;">
                                        <div class="col-md-4">
                                            <input type="text" pattern="[0-9]{11}" title="<?php echo $mobile_error; ?>"
                                                ...
                                                class="form-control" value="<?php echo "" . $data['mobile1'] . ""; ?>" />
                                        </div>

                                        <div class="col-md-4">
                                            <input type="text" pattern="[0-9]{11}" title="<?php echo $mobile_error; ?>"
                                                name="mobile2" placeholder="<?php echo "$Mobile2_lang"; ?>"
                                                class="form-control" value="<?php echo "" . $data['mobile2'] . ""; ?>" />
                                        </div>

                                        <div class="col-md-4">
                                            <select name="alpha" size="1"
                                                class="js-example-placeholder-single4 js-states form-control">
                                                <option value="" <?php if ($data['alpha'] == "") {
                                                    echo 'selected="selected"';
                                                } ?>>المصدر</option>
                                                <?php /* ?>
                                               <option value="A" <?php if ($data['alpha'] == "A") {
                                                   echo 'selected="selected"';
                                               } ?>>A</option>
                                               <option value="B" <?php if ($data['alpha'] == "B") {
                                                   echo 'selected="selected"';
                                               } ?>>B</option>
                                               <?php */ ?>
                                                <option value="C" <?php if ($data['alpha'] == "C") {
                                                    echo 'selected="selected"';
                                                } ?>>C</option>
                                                <?php /* ?>
                                               <option value="D" <?php if ($data['alpha'] == "D") {
                                                   echo 'selected="selected"';
                                               } ?>>D</option>
                                               <option value="E" <?php if ($data['alpha'] == "E") {
                                                   echo 'selected="selected"';
                                               } ?>>E</option>
                                               <option value="F" <?php if ($data['alpha'] == "F") {
                                                   echo 'selected="selected"';
                                               } ?>>F</option>
                                               <option value="G" <?php if ($data['alpha'] == "G") {
                                                   echo 'selected="selected"';
                                               } ?>>G</option>
                                               <option value="H" <?php if ($data['alpha'] == "H") {
                                                   echo 'selected="selected"';
                                               } ?>>H</option>
                                               <?php */ ?>
                                                <option value="i" <?php if ($data['alpha'] == "i") {
                                                    echo 'selected="selected"';
                                                } ?>>i</option>
                                                <?php /* ?>
                                               <option value="J" <?php if ($data['alpha'] == "J") {
                                                   echo 'selected="selected"';
                                               } ?>>J</option>
                                               <option value="K" <?php if ($data['alpha'] == "K") {
                                                   echo 'selected="selected"';
                                               } ?>>K</option>
                                               <option value="L" <?php if ($data['alpha'] == "L") {
                                                   echo 'selected="selected"';
                                               } ?>>L</option>
                                               <option value="M" <?php if ($data['alpha'] == "M") {
                                                   echo 'selected="selected"';
                                               } ?>>M</option>
                                               <option value="N" <?php if ($data['alpha'] == "N") {
                                                   echo 'selected="selected"';
                                               } ?>>N</option>
                                               <option value="O" <?php if ($data['alpha'] == "O") {
                                                   echo 'selected="selected"';
                                               } ?>>O</option>
                                               <?php */ ?>
                                                <option value="P" <?php if ($data['alpha'] == "P") {
                                                    echo 'selected="selected"';
                                                } ?>>P</option>
                                                <?php /* ?>
                                               <option value="Q" <?php if ($data['alpha'] == "Q") {
                                                   echo 'selected="selected"';
                                               } ?>>Q</option>
                                               <option value="R" <?php if ($data['alpha'] == "R") {
                                                   echo 'selected="selected"';
                                               } ?>>R</option>
                                               <option value="S" <?php if ($data['alpha'] == "S") {
                                                   echo 'selected="selected"';
                                               } ?>>S</option>
                                               <option value="T" <?php if ($data['alpha'] == "T") {
                                                   echo 'selected="selected"';
                                               } ?>>T</option>
                                               <option value="U" <?php if ($data['alpha'] == "U") {
                                                   echo 'selected="selected"';
                                               } ?>>U</option>
                                               <option value="V" <?php if ($data['alpha'] == "V") {
                                                   echo 'selected="selected"';
                                               } ?>>V</option>
                                               <?php */ ?>
                                                <option value="W" <?php if ($data['alpha'] == "W") {
                                                    echo 'selected="selected"';
                                                } ?>>W</option>
                                                <?php /* ?>
                                               <option value="X" <?php if ($data['alpha'] == "X") {
                                                   echo 'selected="selected"';
                                               } ?>>X</option>
                                               <?php */ ?>
                                                <option value="Y" <?php if ($data['alpha'] == "Y") {
                                                    echo 'selected="selected"';
                                                } ?>>Y</option>
                                                <?php /* ?>
                                               <option value="Z" <?php if ($data['alpha'] == "Z") {
                                                   echo 'selected="selected"';
                                               } ?>>Z</option>
                                               <?php */ ?>
                                            </select>
                        ...
                        <table width="100%" dir="rtl">
                            <tr>
                                ...
                                <td><input type="text" name="date" id="date"
                                        value="<?php echo date("d/m/Y", strtotime($data['date'])); ?>"
                                ...
                                <td style="font-size:16px;"><input
                                        style="text-align:center; background-color:#CCC; width:80px; height:20px;"
                                        type="text" name="shipping" value="<?php echo "" . $data['shipping'] . ""; ?>" />
                                </td>
                                <td class="text-left" style="font-size:16px;"><?php echo "$Discount_lang"; ?></td>
                                <td><input type="text" name="alldiscount" value="<?php echo "" . $data['discount'] . ""; ?>"
                            ...
                            <tr>
                                ...
                                <td style="font-size:16px;">
                                    <textarea class="form-control" style="text-align: center"
                                        name="notes"><?php echo $data['notes']; ?></textarea>
                                </td>
                        ...
                        <form method="get" class="noprint" style="padding-bottom:20px;">
                            <div class="text-center">
                                <?php if ($run_barcode == 0) {
                                    ...
                                    ?>" autofocus onfocus="this.select()" name="barcode" id="barcode"
                                ...
                                <span style="padding-right:20px;"></span><input type="text"
                                    value="<?php echo "$item_Name_lang"; ?>"
                                    style="background-color:#CCC; z-index:100000000000;"
                                    onkeyup="showResultsOfItems(this.value)" autocomplete="off" onclick="this.value = '';"
                                    onfocus="this.select()"
    ...
    $('select[name="region_id"]').change(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                $('select[name="centers_id"]').html(response);
                $(".js-example-placeholder-single3").select2({
                    placeholder: "اختر المركز",
                    allowClear: true
                });
