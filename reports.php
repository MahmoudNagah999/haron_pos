...
$region_id = (array) ($_GET['region_id'] ?? []);
$products = (array) ($_GET['products'] ?? []);
$centers_id = (array) ($_GET['centers_id'] ?? []);
$branch_id = (array) ($_GET['branch_id'] ?? []);
$status = (array) ($_GET['status'] ?? []);
$groupid = (array) ($_GET['groupid'] ?? []);
$targetpage = "";
?>
                            ...
                            <?php if ($_GET['reports'] == "items_and_inventory" or $_GET['reports'] == null) {
                                ...
                                <form method="get" id="contentnoprint">
                                        ...
                                        if ($_GET['reports'] == "suppliers_receivings" or $_GET['reports'] == "payments_suppliers") {
                                            ...
                                            <div style="width:20%; float:right;"><label style="float:right; ">
                                                ...
                                                <input type="hidden" name="SupplierID"
                                                    value="<?php echo "" . $_GET['SupplierID'] . ""; ?>" />
                                            </div>
                                        <?php } ?>
                                        <?php
                                    ...
                                    <?php if ($_GET['reports'] == "sales") { ?>
                                        <div style="width:10%; float:right;">
                                            ...
                                            <select id="client_id" name="client_id" size="1"
                                                class="w100 placeholder-single w25 js-states  form-control">
                                                <option value=""></option>
                                                <?php
                                    ...
                                    <?php if ($_GET['reports'] == "treasury_statement") { ?>
                                        <div style="width:10%; float:right;">
                                            ...
                                            <select id="safe_id" name="safe_id" size="1"
                                                class="w100 placeholder-single w25 js-states  form-control">
                                                <option value=""></option>
                                                <?php
                                    ...
                                    <?php if ($_GET['reports'] == "stores_change") { ?>
                                        <div style="width:10%; float:right;">
                                            ...
                                            <select id="store_from_id" name="store_from_id" size="1"
                                                class="w100 placeholder-single  js-states  form-control">
                                                <option value=""></option>
                                                <?php
                                        ...
                                        <div style="width:10%; float:right;">
                                            ...
                                            <select id="store_to_id" name="store_to_id" size="1"
                                                class="w100 placeholder-single  js-states  form-control">
                                                <option value=""></option>
                                                <?php
                                                $ProductsName = mysqli_query($con, "SELECT * FROM " . $prefix . "_store order by name ASC");
                                    ...
                                    <?php if ($_GET['reports'] == "receivings" or $_GET['reports'] == "sales") { ?>
                                        ...
                                        <?php //echo"INV#"; 
                                                    ?><!--</label>-->
                                        <!--                                        <input type="text" name="inv" id="inv" dir="rtl" value="-->
                                    ...
                                    <?php if ($_GET['reports'] == "total_item_sale" or $_GET['reports'] == "detailed_sales" or $_GET['reports'] == "sales") { ?>
                                        <div style="width:10%; float:right;"><label style="float:right; ">
                                            ...
                                            <select id="store_id" name="store_id" size="1"
                                                class="w100 placeholder-single  js-states  form-control">
                                                <?php
                                    ...
                                    <?php if ($_GET['reports'] == "total_item_sale" or $_GET['reports'] == "order_supply" or $_GET['reports'] == "sales") { ?>
                                        <div style="width:10%; float:right;"><label style="float:right; ">
                                            ...
                                            <select id="UerID" name="UerID" size="1"
                                                class="w100 placeholder-single  js-states  form-control">
                                                <option value=""></option>
                                                <?php
                                ...
                                <div style="width:10%; float:right;display: none">
                                    ...
                                    <select id="region_id" multiple="multiple" name="region_id[]" size="1" class="w100 placeholder-single_order_status  js-states  form-control">
                                        ...
                                        <div style="width:10%; float:right;">
                                            <label style="float:right; ">
                                                <?php echo $region_lang; ?>
                                            </label>

                                            <select id="region_id" multiple="multiple" name="region_id[]" size="1"
                                                ...
                                                if ($num_item > 0) {
                                                    while ($row_item = mysqli_fetch_array($ProductsName)) {
                                                        ...
                                                        if (in_array($row_item['id'], $region_id)) {
                                                            echo '<option data-attrchangeid ="' . $row_item['id'] . '" value="' . $row_item['id'] . '"   selected="selected">' . $row_item['name'] . '</option>';
                                                        } else {
                                                            echo '<option data-attrchangeid ="' . $row_item['id'] . '" value="' . $row_item['id'] . '">' . $row_item['name'] . '</option>';
                                                        }
                                        ...
                                        <div style="width:10%; float:right;">
                                            ...
                                            <select name="products[]" multiple="multiple" size="1"
                                                class="w100 placeholder-single_order_status  js-states  form-control">
                                                ...
                                                if (@mysqli_num_rows($result_search_products) > 0) {
                                                    while ($row_search_products = mysqli_fetch_array($result_search_products)) {
                                                        if (in_array($row_search_products['id'], $products)) {
                                            ...
                                            <select id="centers_id" multiple="multiple" name="centers_id[]" size="1"
                                                ...
                                                if ($num_item > 0) {
                                                    while ($row_item = mysqli_fetch_array($ProductsName)) {
                                                        ...
                                                        if (in_array($row_item['id'], $centers_id)) {
                                                            echo '<option data-attrchangeid ="' . $row_item['id'] . '" value="' . $row_item['id'] . '"   selected="selected">' . $row_item['name'] . '</option>';
                                                        } else {
                                                            echo '<option data-attrchangeid ="' . $row_item['id'] . '" value="' . $row_item['id'] . '">' . $row_item['name'] . '</option>';
                                                        }
                                              ...
                                              if ($num_Alpha > 0) {
                                                  while ($row_Alpha = mysqli_fetch_array($AlphaName)) {
                                                      ...
                                                      if ( in_array($row_Alpha['id'],$_GET['alpha'])) {
                                                          <option data-attrchangeid ="'.$row_Alpha['id'].'" value="' . $row_Alpha['id'] . '"   selected="selected">' . $row_Alpha['name'] . '</option>
                                                      } else {
                                                          <option data-attrchangeid ="'.$row_Alpha['id'].'" value="' . $row_Alpha['id'] . '">' . $row_Alpha['name'] . '</option>
                                                      }
                                                  }
                                              }*/
                                                ?>
                                    ...
                                    <?php if ($_GET['reports'] == "total_item_sale" or $_GET['reports'] == "sales" or $_GET['reports'] == "detailed_sales") { ?>
                                        <div style="width:10%; float:right;">
                                            <label style="float:right; ">
                                                <?php echo $the_branch_name_lang; ?>
                                            </label>

                                            <select id="branch_id" name="branch_id" size="1"
                                                class="w100 placeholder-single w25 js-states  form-control">
                                                <option value=""></option>
                                                <?php
                                    ...
                                    <?php if ($_GET['reports'] == "order_supply" and ($user_branch_id == 0 or $user_branch_id == '' or $user_branch_id == null)) { ?>
                                        <div style="width:10%; float:right;">
                                            ...
                                            <select id="branch_id" multiple="multiple" name="branch_id[]" size="1"
                                                class="w100 placeholder-single w25 js-states  form-control">
                                                <option value=""></option>
                                                <?php
                                                $ProductsName = mysqli_query($con, "SELECT * FROM " . $prefix . "_branch order by name ASC");
                                                ...
                                                if ($num_item > 0) {
                                                    while ($row_item = mysqli_fetch_array($ProductsName)) {
                                                        if (in_array($row_item['id'], $branch_id)) {
                                                            echo '<option value="' . $row_item['id'] . '"   selected="selected">' . $row_item['name'] . '</option>';
                                                        } else {
                                                            echo '<option data-attrchangeid ="' . $row_item['id'] . '" value="' . $row_item['id'] . '">' . $row_item['name'] . '</option>';
                                                        }
                                    ...
                                    <?php if ($_GET['reports'] == "order_supply") { ?>
                                        <div style="width:10%; float:right;">
                                            ...
                                            <select id="status" multiple="multiple" name="status[]" size="1"
                                                class="w100 placeholder-single_order_status  js-states  form-control">
                                                <option value=""></option>
                                                <?php
                                                ...
                                                if ($num_item > 0) {
                                                    while ($row_item = mysqli_fetch_array($ProductsName)) {
                                                        ...
                                                        if (in_array($row_item['id'], $status)) {
                                                            echo '<option data-attrchangeid ="' . $row_item['id'] . '" value="' . $row_item['id'] . '"   selected="selected">' . $row_item['name'] . '</option>';
                                                        } else {
                                                            echo '<option data-attrchangeid ="' . $row_item['id'] . '" value="' . $row_item['id'] . '">' . $row_item['name'] . '</option>';
                                                        }
                                    ...
                                    <?php if ($_GET['reports'] == "detailed_order_supply" or $_GET['reports'] == "detailed_sales") { ?>
                                        <div style="width:10%; float:right;"><label style="float:right; ">
                                            ...
                                            <select name="groupid[]" multiple="multiple"
                                                class="w100 placeholder-single form-control">
                                                <option value=""></option>
                                                <?php
                                                ...
                                                if ($num_Groups_list > 0) {
                                                    while ($row_Groups_list = mysqli_fetch_array($Groups_list)) {
                                                        if (in_array($row_Groups_list['id'], $groupid)) {
                                    ...
                                    <?php if ($_GET['reports'] == "order_supply") { ?>
                                        <?php if ($user_excel_order_supply !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <div style=" float:right; padding-top:20px; text-align:center;">
                                                <a href="#" id="excel" class="btn btn-danger"> <i class="fa fa-file-excel-o">
                                                        <?php echo "$export_report_lang"; ?>
                                                    </i></a>
                                            </div>
                                        <?php } ?>
                                        <?php if ($user_pdf_order_supply !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <div style=" float:right; padding-top:20px; text-align:center;">
                                                <a href="#" id="allmultiPrint" class="btn btn-primary"><i class="fa fa-print"></i>
                                                    <?php echo $print_all_lang; ?>
                                                </a>
                                            </div>
                                        <?php } ?>
                                    ...
                                    <?php if ($_GET['reports'] == "receivings") {
                                        ...
                                        <div style=" float:right; padding-top:20px; text-align:center;">
                                            <?php if ($user_pdf_order_supply !== "1" and $user_IsAdmin != 1) {
                                                ...
                                                <a href="#" id="allmultiPrintreceivings"><i class="fa fa-print"></i>
                                                    <?php echo $print_all_lang; ?>
                                                </a>
                                    ...
                                    <?php if ($_GET['reports'] == "stores_change") { ?>
                                        ...
                                        <div style=" float:right; padding-top:20px; text-align:center;">
                                            <?php if ($user_stores_change !== "1" and $user_IsAdmin != 1) {
                                                ...
                                                <a href="#" id="allmultiPrint2"><i class="fa fa-print"></i>
                                                    <?php echo $print_all_lang; ?>
                                                </a>
                                    ...
                                    <?php if ($_GET['reports'] == "treasury_statement") { ?>
                                        ...
                                        <div style=" float:right; padding-top:20px; text-align:center;">
                                            <?php if ($user_user_treasury !== "1" and $user_IsAdmin != 1) {
                                                ...
                                                <a href="#" id="allmultiPrintTreauryStatement"><i class="fa fa-print"></i>
                                                    <?php echo $print_lang; ?>
                                                </a>
                            ...
                            if ($_GET['reports'] == "receivings") {
                                ...
                                if ($user_IsAdmin == 1) {
                                    ...
                                    if ($_GET['chart'] == "daily") {
                                        ...
                                        $sql_chart = "SELECT DATE_FORMAT(date, '%d') as monthe,sum($add_sql_disc) as total FROM " . $prefix . "_sales_inv where type in('1','2') and date_format(date, '%Y-%m')=date_format(now(), '%Y-%m') and YEAR(date)='$this_year' group by monthe order by monthe ASC";
                                    } else if ($_GET['chart'] == "monthly") {
                                        echo "<h3>" . $Monthly_sales_lang . "</h3>";
                                        $sql_chart = "SELECT DATE_FORMAT(date, '%m-%Y') as monthe,sum($add_sql_disc) as total FROM " . $prefix . "_sales_inv where type in('1','2') and YEAR(date)='$this_year' group by monthe order by monthe ASC";
                                    } else {
                                        $sql_chart = "SELECT DATE_FORMAT(date, '%m-%Y') as monthe,sum($add_sql_disc) as total FROM " . $prefix . "_sales_inv where type in('1','2')  and YEAR(date)='$this_year' group by monthe order by monthe ASC";
                                    }
       ...
       <li><a href='?chart=daily'>" . $Daily_sales_lang . "</a></li>
                                    ...
                                    ?>
                                                                                                                                                ...
                                                                                                                                                <table class="table table-bordered" border="1"
                                                                                                                                                    style="width:50%; text-align:center; margin:0 auto; border-collapse:collapse;">
                                                                                                                                                    <tr>
                                                                                                                                                        <td>
                                                    ...
                                                    ?>
                                                                                                                                                        ...
                                                                                                                                                        <td>
                                                <?php echo "$Total_cash_treasury_lang"; ?>
                                                                                                                                                        </td>
                                                                                                                                                    </tr>
                                                    ...
                                                    if (@mysqli_num_rows($result_price) > 0) {
                                                        while ($row_price = mysqli_fetch_array($result_price)) {
                                                            $totalgetprice += (float) $row_price['price'] * ((float) $row_price['Quantity'] + (float) GetQuantity($row_price['id']));
                                                        }
                                                    }
                                                    ######################################################
                                                    ...
                                                    ?>
                                                                                                                                                        ...
                                                                                                                                                        <td>
                                                <?php echo "$stock_Purchase_price_lang"; ?>
                                                                                                                                                        </td>
                                                                                                                                                    </tr>
                                                    ...
                                                    if (@mysqli_num_rows($result_Retail_price) > 0) {
                                                        while ($row_Retail_price = mysqli_fetch_array($result_Retail_price)) {
                                                            $totalRetail_price += (float) $row_Retail_price['Retail_price'] * ((float) $row_Retail_price['Quantity'] + (float) GetQuantity($row_Retail_price['id']));
                                                        }
                                                    }
                                                    print round($totalRetail_price, 2);
                                                    ######################################################
                                                    ?>
                                                                                                                                                        </td>
                                                                                                                                                        <td>
                                                <?php echo "$stock_Selling_price_lang"; ?>
                                                                                                                                                        </td>
                                                                                                                                                    </tr>
                            ...
                            <div class="fright" id="contentnoprint3">
                                ...
                                <div id='cssmenu'>
                                    ...
                                    <ul>
                                        ...
                                        <li><a target="_BLANK" href="regions_orders_rate_r.php"><span>اﻻوردرات المجمعه -
                                                    الفروع</span></a></li>
                                        <li><a target="_BLANK" href="orders_rate_emps_r.php"><span>اوردرات الموظفين
                                                    المجمع</span></a></li>
                                        <li><a target="_BLANK" href="branches_rate_emps_r.php"><span>اوردرات الموظفين المجمع -
                                                    الفروع</span></a>
                                        </li>
                                        ...
                                        <?php if ($user_ReportsPurchases !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "receivings" or $_GET['reports'] == "receivings_returns" or $_GET['reports'] == "suppliers_receivings" or $_GET['reports'] == "item_receivings") {
                                                echo "active";
                                                        ...
                                                        <?php echo "$Purchases_lang"; ?>
                                                    </span></a>
                                                <ul>
                                                    <li>
                                                        <a href='?reports=receivings'><span>
                                                                <?php echo "$Purchases_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li>
                                                        <a href='?reports=receivings_returns'><span>
                                                                <?php echo "$Returns_Purchases_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li class='last'><a href='?reports=suppliers_receivings'><span>
                                                                <?php echo "$Purchases_supplier_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li class='last'><a href='?reports=item_receivings'><span>
                                                                <?php echo "$Purchases_items_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        ...
                                        <?php if ($user_SalesReports !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "sales" or $_GET['reports'] == "sales_returns" or $_GET['reports'] == "client_returns" or $_GET['reports'] == "items_returns") {
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href='?reports=detailed_sales'><span>
                                                                <?php echo "تقرير المبيعات التفصيلى"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li><a href='?reports=sales'><span>
                                                                <?php echo "$sales_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li>
                                                        <a href='?reports=item_sale'><span>
                                                                <?php echo "$Sales_items_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li>
                                                        <a href='?reports=total_item_sale'><span>
                                                                <?php echo "$Total_Sales_items_lang"; ?>
                                                            </span></a>
                                                    </li>

                                                    <li>
                                                        <a href='?reports=sales_returns'><span>
                                                                <?php echo "$Sales_returns_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li class='last'><a href='?reports=client_returns'><span>
                                                                <?php echo "$Returns_client_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li class='last'><a href='?reports=items_returns'><span>
                                                                <?php echo "$Return_items_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        ...
                                        <?php if ($user_order_supply_report !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "order_supply" or $_GET['reports'] == "client_returns" or $_GET['reports'] == "items_returns") {
                                                echo "active";
                                                        ...
                                                        <?php echo "$order_supply_lang"; ?>
                                                    </span></a>
                                                <ul>

                                                    <li>
                                                        <a href='?reports=detailed_order_supply'><span>
                                                                <?php echo "تقرير اوامر التوريد التفصيلى"; ?>
                                                            </span></a>
                                                    </li>

                                                    <li>
                                                        <a href='?reports=order_supply'><span>
                                        ...
                                        <?php if ($user_offers !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "offers" or $_GET['reports'] == "client_returns" or $_GET['reports'] == "items_returns") {
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href='?reports=detailed_offers'><span>
                                                                <?php echo "تقرير العروض التفصيلى"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li><a href='?reports=offers'><span>
                                                                <?php echo "$offers_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                </ul>
                                        ...
                                        <?php if ($user_stores_change !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "stores_change" or $_GET['reports'] == "client_returns" or $_GET['reports'] == "items_returns") {
                                                echo "active";
                                                        ...
                                                        <?php echo "$stores_change_lang"; ?>
                                                    </span></a>
                                                <ul>
                                                    <li>
                                                        <a href='?reports=detailed_stores_change'><span>
                                                                <?php echo "تقرير تحويل المخازن التفصيلى"; ?>
                                                            </span></a>
                                                    </li>
                                                    <li>
                                                        <a href='?reports=stores_change'><span>
                                                                <?php echo "$stores_change_lang"; ?>
                                                            </span></a>
                                                    </li>
                                                </ul>
                                        ...
                                        <?php if ($user_ReportsSuppliers !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "payments_suppliers") {
                                                ...
                                                <a href='?reports=payments_suppliers'><span>
                                                        <?php echo "$Suppliers_payments_lang"; ?>
                                                    </span></a>
                                            </li>
                                        ...
                                        <?php if ($user_CustomerReports !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "customer_payments") {
                                                ...
                                                <a href='?reports=customer_payments'><span>
                                                        <?php echo "$Customers_payments_lang"; ?>
                                                    </span></a>
                                            </li>
                                        ...
                                        <?php if ($user_Items !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "items_and_inventory") {
                                                ...
                                                <a href='?reports=items_and_inventory'><span>
                                                        <?php echo "$Items_and_inventory_lang"; ?>
                                                    </span></a>
                                            </li>
                                        ...
                                        <?php if ($user_Revenue !== "1" and $user_IsAdmin != 1) {
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "order_log") {
                                                ...
                                                <a href='?reports=order_log'><span>
                                                        <?php echo "تقرير تعديلات امر توريد"; ?>
                                                    </span></a>
                                            </li>
                                        <?php } ?>
                                            ...
                                            <li class='<?php if ($_GET['reports'] == "treasury" or $_GET['reports'] == "treasury_statement") {
                                                ...
                                                <ul>
                                                    ...
                                                    <li class='<?php if ($_GET['reports'] == "treasury_statement") {
                                                        ...
                                                        <a href='?reports=treasury_statement'><span>
                                                                <?php echo "تفصيل الخزينة"; ?>
                                                            </span></a>
                                                    </li>
                                                </ul>
                                            </li>
